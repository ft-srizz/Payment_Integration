...
<body>
    ...
    <div class="row justify-content-center"></div>
        <div class="col-lg-6 px-4 pb-4">
            <h4 class="text-center text-info p-2">Complete the Transaction</h4>
            ...
            <form action="razorpay-php/Razorpay.php" method="post">
                        ...
                        <input type="text" id="email" name="email" placeholder="your Email" value="" required>
                            ...
                            <div class="col-50">
                                ...
                                <input type="text" id="" name="amount" placeholder="Amount in Rupees">
                            </div>

                        </div>      <button class="btn btn-warning mt-3" type="submit">Proceed to Pay</button>
                    </div>
